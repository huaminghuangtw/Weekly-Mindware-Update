...
| [Previous: Week 42, 2024](2024_Week_42.md) | [Next: Week 44, 2024](../2024/2024_Week_44.md) |
| :---: | :---: |
...
* 雪酪 (Sherbet): (1) 製法是將新鮮水果冷凍至結冰後磨成沙冰 (2) 與冰淇淋的最大的差別，在於其不含牛奶或植物奶的成份
* 克菲爾 (Kefir) 有點像優格，但比優格更濃稠，口感也更綿密，最早起源於北高加索山區 (Caucasus Mountains)
* Anti-Perspirant (止汗劑) stops the sweating by using aluminum to help block the pores, which is bad for your health. \&harr; Deodorant (體香劑) is just for smell and you'll still sweat.
* Voting/Electoral System: (1) First Past the Post (FPTP): voters cast a vote for a single candidate, and the candidate with the most votes wins the election. \&rarr; single winner (2) Block Voting (BV): voters may cast as many votes as the number of seats to be filled. \&rarr; multiple winners
