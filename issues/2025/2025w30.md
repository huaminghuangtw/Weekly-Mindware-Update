...
* 汽車產業供應鏈由 OEM（[Original Equipment Manufacturer](https://en.wikipedia.org/wiki/Original_equipment_manufacturer)，整車廠）主導，但只與 Tier 1（系統與模組供應商）直接採購。Tier 1 向 Tier 2（零件與組件供應商）採購元件，Tier 2 再向 Tier 3（原材料供應商）採購基礎材料。
